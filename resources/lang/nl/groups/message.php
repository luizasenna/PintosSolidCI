...
return array(
    ...
    'group_not_found'     => 'Groep met [:id] bestaat niet.',
    'group_name_required' => 'Veldnaam moet ingevuld worden!',
    ...
    'error' => array(
        'group_exists' => 'Een groep met deze naam bestaat al. Alle groepnamen moeten uniek zijn.',
    ),
