...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li>Usuários</li>
        <li class="active">Adicionar Novos Usuários</li>
    </ol>
</section>
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title"> <i class="livicon" data-name="users" data-size="16" data-c="#fff" data-hc="#fff" data-loop="true"></i>
                        Editando usuário: {!! $user->first_name!!} {!! $user->last_name!!}
                    </h3>
                        ...
                        <div class="col-md-12">
                            ...
                            <form class="form-wizard form-horizontal" action="" method="POST" id="wizard-validation" enctype="multipart/form-data">
                                ...
                                <section>
                                    ...
                                    <div class="form-group">
                                        <p class="text-warning">Se não quiser alterar sua senha, basta deixar o campo em branco.</p>
                                ...
                                <section>
                                    ...
                                    <div class="form-group">
                                        <label for="pic" class="col-sm-2 control-label">Foto</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="form-group">
                                        <label for="bio" class="col-sm-2 control-label">Bio </small></label>
                                        <div class="col-sm-10">
                                ...
                                <section>
                                    ...
                                    <div class="form-group">
                                        <label for="email" class="col-sm-2 control-label">Gênero</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="form-group">
                                        <label for="postal" class="col-sm-2 control-label">Cep</label>
                                        <div class="col-sm-10">
                                ...
                                <section>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span>Se o usáurio não estiver ativo, um email será enviado a ele com um link.</span>
                                    </div>
