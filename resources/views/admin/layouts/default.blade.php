                        ...
                        <li {!! (Request::is('admin/equipamentos') || Request::is('admin/equipamentos/lista') || Request::is('admin/equipamentos/adiciona')? 'class="active"' : '') !!}>
                            ...
                            <ul class="sub-menu">
                                ...
                                <li {!! (Request::is('admin/equipamento/nova') ? 'class="active"' : '') !!}>
                                    <a href="{{ URL::to('admin/equipamento/novo') }}">
                                        <i class="fa fa-angle-double-right"></i>
                                        Inserir
                                    </a>
                                </li>
                         ...
                         <li {!! (Request::is('admin/relatorios') || Request::is('admin/relatorios/index') ? 'class="active"' : '') !!}>
                            <a href="#">
                                <i class="livicon" data-name="medal" data-size="18" data-c="#6CC66C" data-hc="#6CC66C" data-loop="true"></i>
                            ...
                            <ul class="sub-menu">
                                <li {!! (Request::is('admin/relatorio/equipamento/index') ? 'class="active"' : '') !!}>
                                    <a href="{{ URL::to('admin/relatorio/equipamento/index') }}">
                                        <i class="fa fa-angle-double-right"></i>
                                        Equipamentos
                                    </a>
                                </li>
