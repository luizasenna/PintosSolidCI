                    ...
                    <div class="row">
						...
						<div class="col-md-4">
							 <div class="input-group">
                                ...
                                <div class="input-group-addon">Loja</div>

                                <select class="form-control filter_input" name="loja_filter">

                                    <option value="">Todas as lojas</option>

                                    @foreach($lojas as $loja)

                                        <option value="{{ $loja->id }}" {{ $loja->id == $loja_filter ? 'selected' : '' }}>{{ $loja->descricao }}</option>
                 		...
                 		<div class="col-md-4">
                 			 <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="modelo_filter" value="{{ $modelo_filter }}">
                        ...
                        <tbody>
                            ...
                            @forelse($entities as $entity)
                                ...
                                <tr>
                                    ...
                                    <td class="col-md-1 text-center">{{ $entity->setor ? $entity->setor->nome : '--' }}</td>

                                    <td class="col-md-1 text-center">{{ $entity->latesttHistorico ? $entity->latesttHistorico->tipo->descricao: '--' }}</td>
